...
export default function HowItWorks() {
    ...
    const faqItems = [
        {
            question: __('messages.how_it_works.faq_q1', {
                defaultValue: 'كيف أشارك بفكرتي في المنصة؟',
            }),
            answer: __('messages.how_it_works.faq_a1', {
                defaultValue:
                    'يمكنك تقديم فكرتك من خلال إنشاء حساب مجاني ثم النقر على زر "قدّم فكرتك الآن". املأ النموذج بتفاصيل فكرتك بما في ذلك الوصف والميزانية المتوقعة والفئة المناسبة.',
            }),
        },
        {
            question: __('messages.how_it_works.faq_q2', {
                defaultValue: 'ما هي معايير قبول الأفكار؟',
            }),
            answer: __('messages.how_it_works.faq_a2', {
                defaultValue:
                    'يجب أن تكون الفكرة أصلية وقابلة للتنفيذ بميزانية لا تتجاوز 100 دولار. كما يُشترط أن تكون الفكرة غير منفذة كمشروع تجاري قائم وأن لا تنتهك حقوق الملكية الفكرية للغير.',
            }),
        },
        {
            question: __('messages.how_it_works.faq_q3', {
                defaultValue: 'كيف يتم التصويت للأفكار؟',
            }),
            answer: __('messages.how_it_works.faq_a3', {
                defaultValue:
                    'يتم التصويت من خلال نظام تقني يمنع التكرار. لكل مستخدم مسجل صوت واحد لكل فكرة. تشكل أصوات الجمهور ٤٠٪ من النتيجة النهائية بينما تعود الـ ٦٠٪ المتبقية لتقييم لجنة الخبراء.',
            }),
        },
        {
            question: __('messages.how_it_works.faq_q4', {
                defaultValue: 'متى يتم إعلان الفائزين؟',
            }),
            answer: __('messages.how_it_works.faq_a4', {
                defaultValue:
                    'يتم إعلان الفائز بشكل يومي بعد انتهاء فترة التصويت المحددة. يتم التواصل مع الفائز عبر البريد الإلكتروني المسجل خلال ١٤ يوماً من الإعلان.',
            }),
        },
        {
            question: __('messages.how_it_works.faq_q5', {
                defaultValue: 'هل يمكنني سحب فكرتي بعد تقديمها؟',
            }),
            answer: __('messages.how_it_works.faq_a5', {
                defaultValue:
                    'نعم، يمكنك سحب فكرتك في أي وقت قبل بدء فترة التصويت. بعد بدء التصويت، لا يمكن سحب الفكرة ولكن يمكنك تعديل بعض التفاصيل غير الجوهرية.',
            }),
        },
        {
            question: __('messages.how_it_works.faq_q6', {
                defaultValue: 'كيف أكون راعياً لجائزة يومية؟',
            }),
            answer: __('messages.how_it_works.faq_a6', {
                defaultValue:
                    'يمكنك التواصل معنا عبر صفحة "تواصل معنا" واختيار موضوع "رعاية". سيقوم فريقنا بالرد عليك خلال ٤٨ ساعة عمل لمناقشة تفاصيل الرعاية والفوائد المرتبطة بها.',
            }),
        },
    ];
        ...
        <>
            ...
            <section className="relative flex h-[280px] items-center justify-center overflow-hidden bg-secondary md:h-[350px]">
                <div className="absolute inset-0 z-0">
                    ...
                    <div className="pointer-events-none absolute inset-0 opacity-10">
                        <span className="material-symbols-outlined absolute end-[20%] top-20 scale-125 text-primary">
                            lightbulb
                        </span>
                        <span className="material-symbols-outlined absolute start-[15%] bottom-20 scale-110 text-primary">
                            rocket_launch
                        </span>
                    </div>
                </div>
                <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
                    ...
                    <h1 className="mb-4 font-headline text-xl leading-tight font-extrabold text-white md:text-3xl">
                        ...
                        <span className="text-inverse-primary">
                            {__('messages.how_it_works.hero_steps')}
                        </span>
                    </h1>
                        ...
                        {steps.map((step, index) => (
                            <div key={step.number} className="relative">
                                ...
                                {index < steps.length - 1 && (
                                    <div className="absolute -start-4 top-1/2 hidden -translate-y-1/2 lg:block">
                        ...
                        {faqItems.map((item, index) => (
                            ...
                            >
                                <summary className="flex cursor-pointer items-center justify-between p-3.5 px-6 font-bold text-on-surface dark:text-white">
                                    ...
                                    <span className="material-symbols-outlined text-lg text-primary transition-transform group-open:rotate-180">
                                        expand_more
                                    </span>
                                </summary>
            ...
            <section className="relative overflow-hidden bg-secondary px-8 py-12">
                <div className="absolute inset-0 opacity-10">
                    <span className="material-symbols-outlined absolute end-[10%] top-10 scale-110 text-primary">
                        celebration
                    </span>
                    <span className="material-symbols-outlined absolute start-[15%] bottom-10 scale-100 text-primary">
                        stars
                    </span>
                </div>
