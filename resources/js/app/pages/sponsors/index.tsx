...
export default function SponsorsIndex({ sponsors, today }: Props) {
    ...
    return (
        <>
            ...
            <section id="sponsors-list" className="mx-auto max-w-7xl scroll-mt-20 px-4 py-20 sm:px-6 lg:px-8 lg:py-24">
                ...
                <div className="grid auto-rows-[minmax(240px,_1fr)] grid-cols-1 gap-4 sm:gap-5 md:grid-cols-2 lg:auto-rows-[minmax(260px,_1fr)] xl:grid-cols-4">
                    {fullWeekSponsors.map((item) => (
                        <div
                            ...
                            className={cn(
                                'h-full',
                                item.isFeatured && 'md:col-span-2 lg:row-span-2 xl:col-span-2',
                            )}
                        >
                            <SponsorCard item={item} isFeatured={item.isFeatured} />
                        </div>
                    ))}
...
function SponsorCard({
    ...
    if (!data) {
        return (
            <div
                className={cn(
                    'group relative flex h-full min-h-[240px] flex-col justify-between overflow-hidden rounded-3xl border border-outline-variant/20 bg-surface-container-low p-5 transition-all duration-500 hover:border-primary/30 dark:bg-surface-container-high md:p-6',
            ...
            >
                ...
                <div className={cn(
                    ...
                    isFeatured ? 'mb-6 flex-1 min-h-[180px]' : 'min-h-[160px]',
                )}>
    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 flex h-full flex-col justify-between p-5 md:p-6">
                ...
                <div className="text-start">
                    <h3 className={cn(
                        'font-headline font-black leading-tight text-white drop-shadow-sm',
...
function SponsorCtaCard() {
    ...
    return (
        <div className="group relative flex h-full min-h-[240px] flex-col items-center justify-center overflow-hidden rounded-3xl border-2 border-dashed border-primary/20 bg-primary/5 p-6 text-center transition-all duration-500 hover:border-primary/40 md:col-span-2 md:min-h-[320px] lg:row-span-2 lg:min-h-[360px] xl:col-span-2">
            ...
            <h3 className="relative mb-2 font-headline text-xl font-black text-on-surface dark:text-white md:text-2xl">
            ...
            <Button asChild size="sm" className="relative h-10 rounded-xl px-6 text-sm font-black shadow-lg shadow-primary/10">
                <Link href="/sponsors/apply">
