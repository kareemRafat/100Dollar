                    ...
                    <div className="flex-1 space-y-6">
                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                            <div className="space-y-2">
                                <Label htmlFor="name" className="px-1 text-[11px] font-black uppercase tracking-wider text-on-surface-variant">
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="email" className="px-1 text-[11px] font-black uppercase tracking-wider text-on-surface-variant">
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="phone" className="px-1 text-[11px] font-black uppercase tracking-wider text-on-surface-variant">
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="bio" className="px-1 text-[11px] font-black uppercase tracking-wider text-on-surface-variant">
                                {__('messages.profile.bio')}
                            </Label>
                            <textarea
                                id="bio"
                                className="min-h-24 w-full rounded-xl border-none bg-surface-container-low p-3 text-sm transition-all focus:ring-1 focus:ring-primary dark:bg-surface-container-low dark:text-white"
                                value={data.bio}
                                onChange={(e) => setData('bio', e.target.value)}
                                placeholder={__('messages.profile.bio_placeholder')}
                            />
                            {errors.bio && <p className="mt-1 text-xs text-error">{errors.bio}</p>}
                        </div>
