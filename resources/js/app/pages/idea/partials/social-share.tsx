...
export const SocialShare = React.memo(({ idea }: SocialShareProps) => {
    ...
    return (
        <div className="bg-surface-container-lowest rounded-xl p-6 border border-outline-variant/10 shadow-sm">
            <p className="text-[10px] font-black text-on-surface-variant uppercase tracking-widest mb-4 text-center font-headline">
            ...
            <div className="grid grid-cols-5 items-center gap-2">
                ...
                >
                    <svg className="h-5 w-5 fill-whatsapp group-hover:fill-white transition-colors" viewBox="0 0 24 24">
                ...
                >
                    <svg className="h-5 w-5 fill-facebook group-hover:fill-white transition-colors" viewBox="0 0 24 24">
                ...
                >
                    <svg className="h-4 w-4 fill-on-surface group-hover:fill-surface-container-lowest transition-colors" viewBox="0 0 24 24">
                ...
                >
                    <svg className="h-5 w-5 fill-linkedin group-hover:fill-white transition-colors" viewBox="0 0 24 24">
