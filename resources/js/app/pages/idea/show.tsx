            ...
            <main className="pb-24">
                ...
                <section className="relative h-[400px] w-full overflow-hidden mb-12">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
                        <div className="bg-primary/90 text-on-primary px-4 py-1 rounded-full text-xs font-bold mb-4 tracking-widest uppercase">
                            {idea.category}
                        </div>
                ...
                <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                    ...
                    <aside className="lg:col-span-4 order-1 lg:order-2 space-y-6">
                            ...
                            <div className="flex flex-col items-center text-center mb-8">
                                <div className="relative w-32 h-32 flex items-center justify-center mb-6">
                                    ...
                                    <div className="absolute inset-0 flex flex-col items-center justify-center">
                                        <span className="text-2xl font-extrabold text-secondary">{votePercentage}%</span>
                                        <span className="text-[10px] text-outline font-bold uppercase tracking-wider">{__('messages.home.vote_progress')}</span>
                                    </div>
                                </div>
                                <h3 className="text-xl font-bold text-secondary mb-2 font-headline">{__('messages.home.vote_now')}</h3>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <button
                                className={`flex flex-col items-center justify-center gap-2 p-4 rounded-xl bg-white border border-outline-variant/10 shadow-sm transition-all group ${isFollowingIdea ? 'border-primary' : 'hover:border-primary'}`}
                            >
                                <div className={`p-2 rounded-lg transition-colors ${isFollowingIdea ? 'bg-primary text-white' : 'bg-primary/5 text-primary group-hover:bg-primary group-hover:text-white'}`}>
                                    <Bell className="w-5 h-5" />
                                </div>
                                <span className="text-[10px] font-black uppercase tracking-wider text-secondary">{__('messages.archive.follow_idea')}</span>
                            </button>
                            <button
                                className={`flex flex-col items-center justify-center gap-2 p-4 rounded-xl bg-white border border-outline-variant/10 shadow-sm transition-all group ${isFollowingOwner ? 'border-primary' : 'hover:border-primary'}`}
                            >
                                <div className={`p-2 rounded-lg transition-colors ${isFollowingOwner ? 'bg-primary text-white' : 'bg-primary/5 text-primary group-hover:bg-primary group-hover:text-white'}`}>
                                    <UserPlus className="w-5 h-5" />
                                </div>
                                <span className="text-[10px] font-black uppercase tracking-wider text-secondary">{__('messages.archive.follow_owner')}</span>
                            </button>
                        </div>
                        ...
                        <div className="bg-surface-container-low rounded-xl p-6">
                            ...
                            <div className="flex justify-between items-center gap-3">
                                <button
                                    ...
                                    className="flex-1 bg-white p-3 rounded-lg shadow-sm hover:shadow-md transition-all flex items-center justify-center text-[#25D366] hover:bg-[#25D366] hover:text-white">
                                ...
                                <button
                                    ...
                                    className="flex-1 bg-white p-3 rounded-lg shadow-sm hover:shadow-md transition-all flex items-center justify-center text-[#1877F2] hover:bg-[#1877F2] hover:text-white">
                                    <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24">
                                ...
                                <button
                                    ...
                                    className="flex-1 bg-white p-3 rounded-lg shadow-sm hover:shadow-md transition-all flex items-center justify-center text-black hover:bg-black hover:text-white">
                                    <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24">
                                ...
                                <button
                                    ...
                                    className="flex-1 bg-white p-3 rounded-lg shadow-sm hover:shadow-md transition-all flex items-center justify-center text-secondary hover:bg-secondary hover:text-white">
                        ...
                        <section className="bg-surface-container-lowest p-8 lg:p-12 rounded-xl border border-outline-variant/10 arabic-dynamic-padding">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center justify-between p-4 bg-surface rounded-lg border-r-4 border-primary">
                                    <span className="font-medium text-secondary">{__('messages.submit_idea.details_label')}</span>
                                            ...
                                            comments.data.map((comment, index) => (
                                                <div key={comment.id}>
                                                    <div className="group relative bg-white rounded-xl p-6 border border-outline-variant/40 hover:border-primary/30 hover:shadow-md transition-all duration-300">
                                                        ...
                                                        <p className="text-secondary text-lg leading-relaxed pr-0 md:pr-16 font-bold whitespace-pre-wrap">
                                                            {comment.body}
                                                        </p>
                                                    </div>
