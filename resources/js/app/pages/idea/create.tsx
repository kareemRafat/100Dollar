                        ...
                        >
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    placeholder={__(
                                        'messages.submit_idea.title_placeholder',
                                    )}
                                    type="text"
                                    value={data.title}
                                    onChange={(e) =>
                            ...
                            <div className="space-y-2">
                                ...
                                >
                                    ...
                                    >
                                        <SelectValue
                                            placeholder={__(
                                                'messages.submit_idea.category_placeholder',
                                            )}
                                        />
                                    </SelectTrigger>
                                    <SelectContent>
                            ...
                            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        className="w-full border-none bg-surface-container-low px-4 text-on-surface transition-all focus:bg-white focus:ring-2 focus:ring-primary dark:bg-surface-container-high dark:text-white dark:focus:bg-surface-container-highest"
                                        placeholder={__(
                                            'messages.submit_idea.city_placeholder',
                                        )}
                                        type="text"
                                        value={data.city}
                                        onChange={(e) =>
                            ...
                            <div className="space-y-2">
                                ...
                                <MultiSelect
                                    options={[
                                        {
                                            label: __(
                                                'messages.submit_idea.audiences.youth',
                                            ),
                                            value: 'youth',
                                        },
                                        {
                                            label: __(
                                                'messages.submit_idea.audiences.students',
                                            ),
                                            value: 'students',
                                        },
                                        {
                                            label: __(
                                                'messages.submit_idea.audiences.entrepreneurs',
                                            ),
                                            value: 'entrepreneurs',
                                        },
                                        {
                                            label: __(
                                                'messages.submit_idea.audiences.housewives',
                                            ),
                                            value: 'housewives',
                                        },
                                        {
                                            label: __(
                                                'messages.submit_idea.audiences.professionals',
                                            ),
                                            value: 'professionals',
                                        },
                                        {
                                            label: __(
                                                'messages.submit_idea.audiences.small_business_owners',
                                            ),
                                            value: 'small_business_owners',
                                        },
                                        {
                                            label: __(
                                                'messages.submit_idea.audiences.children',
                                            ),
                                            value: 'children',
                                        },
                                        {
                                            label: __(
                                                'messages.submit_idea.audiences.elderly',
                                            ),
                                            value: 'elderly',
                                        },
                                    ]}
                                    ...
                                    placeholder={__(
                                        'messages.submit_idea.target_audience_placeholder',
                                    )}
                                    variant="inverted"
                                    dir={locale === 'ar' ? 'rtl' : 'ltr'}
                            ...
                            <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                                    ...
                                    >
                                        {[
                                            ...
                                            >
                                                <Checkbox
                                                    id={`channel-${channel}`}
                                                    checked={data.marketing_channel.includes(
                                                        channel,
                                                    )}
                                                    onCheckedChange={(
                                                        checked,
                                ...
                                <div className="space-y-4">
                                    ...
                                    >
                                        {[
                                            ...
                                            >
                                                ...
                                                >
                                                    {__(
                                                        `messages.submit_idea.times.${time}`,
                                                    )}
                                                </Label>
                                            </div>
                                        ))}
                                    ...
                                    <InputError
                                        message={
                                            errors.implementation_time
                                                ? __(errors.implementation_time)
                                                : undefined
                                        }
                                    />
                                </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <Textarea
                                    ...
                                    placeholder={__(
                                        'messages.submit_idea.details_placeholder',
                                    )}
                                    rows={6}
                                ...
                                >
                                    ...
                                    <div className="relative z-10 flex flex-col items-center">
                                        <p className="text-center font-headline text-sm font-bold text-on-surface dark:text-white">
                                            {isDragging
                                                ? __(
                                                      'messages.submit_idea.drop_to_upload',
                                                  )
                                                : imagePreview
                                                  ? __(
                                ...
                                <div className="flex items-center gap-4 rounded-lg border border-outline-variant/10 bg-surface-container-low p-4 dark:bg-surface-container-high">
                                    ...
                                    <span className="flex-grow truncate text-sm text-on-surface dark:text-white">
                                        {data.pdf_file
                                            ? data.pdf_file.name
                                            : __(
                                                  'messages.submit_idea.file_placeholder',
                                              )}
                                    </span>
                                    <button
                                    ...
                                    >
                                        {__(
                                            'messages.submit_idea.browse_device',
                                        )}
                                    </button>
                                    <input
                                        id="file-upload"
                            ...
                            <div
                                className="space-y-4 border-t border-outline-variant/20 pt-6 dark:border-outline-variant/10"
                                dir={locale === 'ar' ? 'rtl' : 'ltr'}
                            >
                                <div className="group flex items-start gap-3">
                                    <Checkbox
                                        ...
                                        onCheckedChange={(checked) =>
                                            setData('agreed_terms', !!checked)
                                        }
                                    />
                                    <Label
                                        htmlFor="agreed_terms"
                                        className="cursor-pointer text-start text-sm leading-relaxed font-normal text-on-surface group-hover:text-on-surface dark:text-white dark:text-white/80"
                                    >
                                ...
                                <div className="group flex items-start gap-3">
                                    <Checkbox
                                        ...
                                        onCheckedChange={(checked) =>
                                            setData('agreed_privacy', !!checked)
                                        }
                                    />
                                    <Label
                                        htmlFor="agreed_privacy"
                                        className="cursor-pointer text-start text-sm leading-relaxed font-normal text-on-surface group-hover:text-on-surface dark:text-white dark:text-white/80"
                                    >
                                        {__(
                                            'messages.submit_idea.pledge_originality',
                                        )}
                                    </Label>
                                </div>
                                <InputError
                                ...
                                <div className="group flex items-start gap-3">
                                    <Checkbox
                                        ...
                                        onCheckedChange={(checked) =>
                                            setData('agreed_legal', !!checked)
                                        }
                                    />
                                    <Label
                                        htmlFor="agreed_legal"
                                        className="cursor-pointer text-start text-sm leading-relaxed font-normal text-on-surface group-hover:text-on-surface dark:text-white dark:text-white/80"
                                    >
                                        {__(
                                            'messages.submit_idea.agreed_legal',
                                        )}
                                    </Label>
                                </div>
                                <InputError
                                ...
                                >
                                    <span>
                                        {processing
                                            ...
                                            : __(
                                                  'messages.submit_idea.submit_button',
                                              )}
                                    </span>
