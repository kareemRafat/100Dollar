...
- [x] **Migration:** Create `database/migrations/xxxx_add_voting_ends_at_to_ideas_table.php`
    - Add nullable `voting_ends_at` timestamp
- [x] **Model:** Edit `app/Models/Idea.php`
...
- [x] **Admin Idea Approve:** Edit `app/Http/Controllers/Admin/IdeaController.php`
    - When approving, set `'voting_ends_at' => now()->addDays(7)`
- [x] **Vote Guard:** Edit `app/Http/Controllers/App/VoteController.php`
    - In both `sendOtp()` and `verifyOtp()`, add early check:
      ...
      ```
- [x] **Auto-Winner Command:** Rewrite `app/Console/Commands/AnnounceWinner.php`
...
- [x] **Winner Preview:** Edit `app/Http/Controllers/Admin/WinnerController.php`
    - Update `index()` to include voting period status per idea:
      ...
      ```
- [x] **Admin Winners UI:** Edit `resources/js/admin/pages/winners/preview.tsx`
...
- [x] **Idea Resource:** Edit `app/Http/Resources/App/IdeaResource.php`
    - Expose `voting_ends_at` to the frontend
- [x] **TypeScript Types:** Edit `resources/js/types/models.ts`
    - Add `voting_ends_at?: string` to `Idea` interface
- [x] **Voting Card:** Edit `resources/js/app/pages/idea/partials/voting-card.tsx`
...
### Phase 5: Schedule
- [x] **Console Schedule:** Edit `routes/console.php`
